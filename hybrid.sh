...
echo ""
echo "Wallet 1:"
echo "HOME=$BASE_DIR/w1 python3 $MINE_DIR/scripts/run_tool.py agent-control status"
...
echo ""
echo "Wallet 1:"
echo "HOME=$BASE_DIR/w1 python3 $MINE_DIR/scripts/run_tool.py agent-control stop"
